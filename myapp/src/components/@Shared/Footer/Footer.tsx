    ...
    <FooterContainer>
      <FooterBox>
        <FooterLinkBar>
          ...
          <MiniLogoBox>
            <a href="https://www.codeit.kr" target="_blank">
              <img src={facebookIc} width="20px" height="20px" alt="페이스북_링크_아이콘" />
            </a>
            <a href="https://www.codeit.kr" target="_blank">
              <img src={twitterIc} width="20px" height="20px" alt="트위터_링크_아이콘" />
            </a>
            <a href="https://www.codeit.kr" target="_blank">
              <img src={youtubeIc} width="20px" height="20px" alt="유튜브_링크_아이콘" />
            </a>
            <a href="https://www.codeit.kr" target="_blank">
              <img src={instagramIc} width="20px" height="20px" alt="인스타그램_링크_아이콘" />
            </a>
          </MiniLogoBox>
        </FooterLinkBar>
      </FooterBox>
